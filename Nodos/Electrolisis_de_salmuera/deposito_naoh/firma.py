"""Firma HMAC compartida para detectar manipulacion de datos en transito (MITM).

Cada sensor firma sus valores con una clave secreta compartida; la salmuera
verifica la firma antes de confiar en los datos. Si un intermediario altera los
valores sin conocer la clave, la firma deja de cuadrar y el ataque queda en
evidencia. No cifra (los valores siguen legibles), solo garantiza integridad y
